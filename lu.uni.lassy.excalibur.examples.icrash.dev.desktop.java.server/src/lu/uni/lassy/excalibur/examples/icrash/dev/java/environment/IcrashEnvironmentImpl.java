...
public class IcrashEnvironmentImpl extends UnicastRemoteObject implements IcrashEnvironment {
	...
	/** The Police stored in the environment. 
	 * Key = ActPolice's login's name*/
	private Hashtable<String, ActPolice> polices = new Hashtable<String, ActPolice>();
	...
	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.IcrashEnvironment#setActPolice(java.lang.String, lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActPolice)
	 */
	public void setActPolice(String keyName, ActPolice aActPolice){
		polices.put(keyName, aActPolice);
	}

	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.IcrashEnvironment#getActPolice(java.lang.String)
	 */
	public ActPolice getActPolice(String keyName){
		return polices.get(keyName);
	}
	/* (non-Javadoc)
