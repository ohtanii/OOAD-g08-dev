...
public class ActAdministratorImpl extends ActAuthenticatedImpl implements
	...
	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActAdministrator#oeAddPolice(lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtPoliceID, lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtLogin, lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtPassword)
	 */
	synchronized public PtBoolean oeAddPolice(
			DtPoliceID aDtPoliceID, DtLogin aDtLogin,
			DtPassword aDtPassword) throws RemoteException, NotBoundException {
		...
		log.info("message ActAdministrator.oeAddPolice sent to system");
		PtBoolean res = iCrashSys_Server.oeAddPolice(aDtPoliceID,
				aDtLogin, aDtPassword);

		if (res.getValue() == true)
			log.info("operation oeAddPolice successfully executed by the system");

		return res;
	}

	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActAdministrator#oeDeletePolice(lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtPoliceID)
	 */
	synchronized public PtBoolean oeDeletePolice(
			DtPoliceID aDtPoliceID) throws RemoteException,
			NotBoundException {
		...
		log.info("message ActAdministrator.oeDeletePolice sent to system");
		PtBoolean res = iCrashSys_Server.oeDeletePolice(aDtPoliceID);

		if (res.getValue() == true)
			log.info("operation oeDeletePolice successfully executed by the system");
	...
	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActAdministrator#iePoliceAdded()
	 */
	public PtBoolean iePoliceAdded() {
		for (Iterator<ActProxyAuthenticated> iterator = listeners.iterator(); iterator
			...
			try {
				if (aProxy instanceof ActProxyAdministrator)
					((ActProxyAdministrator) aProxy).iePoliceAdded();
			} catch (RemoteException e) {
				Log4JUtils.getInstance().getLogger().error(e);
				iterator.remove();
			}
	...
	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActAdministrator#iePoliceDeleted()
	 */
	public PtBoolean iePoliceDeleted() {
		for (Iterator<ActProxyAuthenticated> iterator = listeners.iterator(); iterator
			...
			try {
				if (aProxy instanceof ActProxyAdministrator)
					((ActProxyAdministrator) aProxy).iePoliceDeleted();
			} catch (RemoteException e) {
				Log4JUtils.getInstance().getLogger().error(e);
				iterator.remove();
			}
	...
	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActAdministrator#iePoliceUpdated()
	 */
	@Override
	public PtBoolean iePoliceUpdated() throws RemoteException {
		for (Iterator<ActProxyAuthenticated> iterator = listeners.iterator(); iterator
			...
			try {
				if (aProxy instanceof ActProxyAdministrator)
					((ActProxyAdministrator) aProxy).iePoliceUpdated();
			} catch (RemoteException e) {
				Log4JUtils.getInstance().getLogger().error(e);
				iterator.remove();
			}
