...
public interface ActAdministrator extends ActAuthenticated {
	 ...
	 *
	 * @param aDtCoordinatorID The ID to use when creating the Police
	 ...
	 *
	 * @param aDtCoordinatorID The ID to use when looking for the Police to delete
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 * @throws NotBoundException Thrown if the server has not been bound correctly in RMI settings
	 */
	public PtBoolean oeDeletePolice(DtPoliceID aDtPoliceID)
			throws RemoteException, NotBoundException;
	
	/**
	 * A message sent to the listening actor saying the Police was created .
	 *
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
	...
	/**
	 * A message sent to the listening actor saying the Police was deleted.
	 *
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
	...
	/**
	 * A message sent to the listening actor saying the Police was updated.
	 *
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
