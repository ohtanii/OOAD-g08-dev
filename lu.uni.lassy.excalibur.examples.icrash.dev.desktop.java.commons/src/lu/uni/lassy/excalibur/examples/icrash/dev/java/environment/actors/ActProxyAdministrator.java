...
public interface ActProxyAdministrator extends ActProxyAuthenticated {
	...
	/**
	 * Add a Police to the system, using the parameters passed.
	 *
	 * @param aDtPoliceID The ID to use when creating the Police
	 * @param aDtLogin The username to use when creating the Police
	 * @param aDtPassword The password to use when creating the Police
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 * @throws NotBoundException Thrown if the server has not been bound correctly in RMI settings
	 */
	public PtBoolean oeAddPolice(DtPoliceID aDtPoliceID, DtLogin aDtLogin,DtPassword aDtPassword) throws RemoteException, NotBoundException;
	
	/**
	 * Delete a Police to the system, using the parameters passed.
	 *
	 * @param aDtPoliceID The ID to use when looking for the Police to delete
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 * @throws NotBoundException Thrown if the server has not been bound correctly in RMI settings
	 */
	public PtBoolean oeDeletePolice(DtPoliceID aDtPoliceID) throws RemoteException, NotBoundException;
	
	/**
	 * A message received from the server side actor saying the Police was created .
	 *
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
	public PtBoolean iePoliceAdded() throws RemoteException;
	
	/**
	 * A message received from the server side actor saying the Police was deleted.
	 *
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
	public PtBoolean iePoliceDeleted() throws RemoteException;
	
	/**
	 * A message received from the server side actor saying the Police was updated.
	 *
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
