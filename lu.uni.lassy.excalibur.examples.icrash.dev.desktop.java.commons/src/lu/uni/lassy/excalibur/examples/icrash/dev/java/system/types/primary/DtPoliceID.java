 ...
 */
public class DtPoliceID extends DtString implements JIntIs{
		...
		public PtString getExpectedDataStructure(){
			return new PtString("Expected strucutre of the Police ID is to have a minimum length greater than " + _minLength + " and a maximum length of " + _maxLength); 
		}
}
