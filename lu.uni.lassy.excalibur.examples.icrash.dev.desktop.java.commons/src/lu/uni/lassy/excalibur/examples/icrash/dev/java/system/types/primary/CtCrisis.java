...
public class CtCrisis implements Serializable {
	...
	/**
	 * Used to provide a given Police with current alert information.
	 *
	 * @param aActPolice the actor coordinator to send the information to
	 * @return the success of the method
	 * @throws RemoteException Thrown if the remote destination is unreachable
	 */
	public PtBoolean isSentToPolice(ActPolice aActPolice) throws RemoteException {
		
		aActPolice.ieSendACrisis(this);
		return new PtBoolean(true);
	}
