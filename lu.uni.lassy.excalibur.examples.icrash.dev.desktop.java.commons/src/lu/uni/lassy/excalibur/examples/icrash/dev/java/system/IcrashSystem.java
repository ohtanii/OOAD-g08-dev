...
public interface IcrashSystem extends Remote {
	...
	/**
	 * Gets a random class type Police from the system.
	 *
	 * @return the random class type coordinator that has been selected
	 * @throws RemoteException Thrown if the server is offline
	 */
	...
	/**
	 * Gets the actor Police with the same class type Police passed.
	 *
	 * @param keyCtPolice the class type Police to use to retrieve the associated actor Police
	 * @return the actor Police retrieved from the system
	 * @throws RemoteException Thrown if the server is offline
	 */
	public ActPolice getActPolice(CtPolice keyCtPolice) throws RemoteException; 
	...
	/**
	 * Binds the class type crisis to the class type Police.
	 *
	 * @param aCtCrisis the class type crisis to bind a Police to
	 * @param aCtPolice the a class type Police to bind to the crisis
	 * @throws RemoteException Thrown if the server is offline
	 */
	public void bindCtCrisisCtPolice(CtCrisis aCtCrisis,CtPolice aCtPolice) throws RemoteException; 
	...
	/**
	 * Gets a list of all class type Police in the system.
	 *
	 * @return all of the class type Police
	 * @throws RemoteException Thrown if the server is offline
	 */
	...
	/**
	 * Adds a Police with the details specified.
	 *
	 * @param aDtPoliceID The ID to create the Police with
	 * @param aDtLogin The username of the Police to create
	 * @param aDtPassword The password of the Police to create
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
	public PtBoolean oeAddPolice(DtPoliceID aDtPoliceID,DtLogin aDtLogin,DtPassword aDtPassword) throws RemoteException;
	/**
	...
	/**
	 * Deletes a Police with the details specified.
	 *
	 * @param aDtPoliceID The Police ID to delete from the system
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
