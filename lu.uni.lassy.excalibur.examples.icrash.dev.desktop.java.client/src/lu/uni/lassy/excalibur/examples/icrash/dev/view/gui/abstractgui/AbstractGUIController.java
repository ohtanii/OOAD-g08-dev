...
public abstract class AbstractGUIController implements Initializable {
	...
	/**
	 * Sets up the Police tableviews with the correct columns.
	 *
	 * @param tblvw The tableview to add the columns to
	 * @param showPassword If true, we show the password in the table, otherwise we do not
	 */
	public void setUpPoliTables(TableView<CtPolice> tblvw, boolean showPassword){
		TableColumn<CtPolice, String> idCol = new TableColumn<CtPolice, String>("ID");
		TableColumn<CtPolice, String> nameCol = new TableColumn<CtPolice, String>("Username");
		TableColumn<CtPolice, String> passwordCol = new TableColumn<CtPolice, String>("Password");
		idCol.setCellValueFactory(new Callback<CellDataFeatures<CtPolice, String>, ObservableValue<String>>() {
			public ObservableValue<String> call(CellDataFeatures<CtPolice, String> poli) {
				return new ReadOnlyObjectWrapper<String>(poli.getValue().id.value.getValue());
			}
		});
		nameCol.setCellValueFactory(new Callback<CellDataFeatures<CtPolice, String>, ObservableValue<String>>() {
			public ObservableValue<String> call(CellDataFeatures<CtPolice, String> poli) {
				return new ReadOnlyObjectWrapper<String>(poli.getValue().login.value.getValue());
			}
		});
		passwordCol.setCellValueFactory(new Callback<CellDataFeatures<CtPolice, String>, ObservableValue<String>>() {
			public ObservableValue<String> call(CellDataFeatures<CtPolice, String> poli) {
				return new ReadOnlyObjectWrapper<String>(poli.getValue().pwd.value.getValue());
			}
		});
		tblvw.getColumns().add(idCol);
		tblvw.getColumns().add(nameCol);
	 ...
	 * @param tblvw The tableview to add the columns to
	 */
	public void setUpCrisesTablesPoli(TableView<CtCrisis>tblvw){
		TableColumn<CtCrisis, String> idCol = new TableColumn<CtCrisis, String>("ID");
		TableColumn<CtCrisis, String> dateCol = new TableColumn<CtCrisis, String>("Date");
		TableColumn<CtCrisis, String> timeCol = new TableColumn<CtCrisis, String>("Time");
		TableColumn<CtCrisis, String> typeCol = new TableColumn<CtCrisis, String>("Type");
	...
	/**
	 * Adds the provided list of Police to the tableview.
	 *
	 * @param tblvw The tableview to add the data to
	 * @param listOfItems the list of items to add to the tableview
	 */
	public void addPolisToTableView(TableView<CtPolice> tblvw, List<CtPolice> listOfItems){
		tblvw.getItems().clear();
		tblvw.getItems().addAll(listOfItems);
	}
