...
public class ActProxyAdministratorImpl extends ActProxyAuthenticatedImpl implements ActProxyAdministrator {
	...
	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActProxyAdministrator#oeAddPolice(lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtPoliceID, lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtLogin, lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtPassword)
	 */
	synchronized public PtBoolean oeAddPolice(DtPoliceID aDtPoliceID, DtLogin aDtLogin, DtPassword aDtPassword) throws RemoteException, NotBoundException {
		if(getServerSideActor() !=null)
			return ((ActAdministrator) getServerSideActor()).oeAddPolice(aDtPoliceID, aDtLogin, aDtPassword);
		else
			return new PtBoolean(false);
	}

	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActProxyAdministrator#oeDeletePolice(lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtPoliceID)
	 */
	synchronized public PtBoolean oeDeletePolice(DtPoliceID aDtPoliceID) throws RemoteException, NotBoundException{
		if(getServerSideActor() !=null)
			return ((ActAdministrator) getServerSideActor()).oeDeletePolice(aDtPoliceID);
		else
			return new PtBoolean(false);
	}

	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActProxyAdministrator#iePoliceAdded()
	 */
	public PtBoolean iePoliceAdded(){
		Logger log = Log4JUtils.getInstance().getLogger();
		log.info("message ActAdministrator.iePoliceAdded received from system");
		listOfMessages.add(new Message(MessageType.iePoliceAdded));
		return new PtBoolean(true);
	}

	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActProxyAdministrator#iePoliceDeleted()
	 */
	public PtBoolean iePoliceDeleted(){
		Logger log = Log4JUtils.getInstance().getLogger();
		log.info("message ActAdministrator.iePoliceDeleted received from system");
		listOfMessages.add(new Message(MessageType.iePoliceDeleted));
		return new PtBoolean(true);
	}

	/* (non-Javadoc)
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActProxyAdministrator#iePoliceUpdated()
	 */
	@Override
	public PtBoolean iePoliceUpdated() throws RemoteException {
		Logger log = Log4JUtils.getInstance().getLogger();
		log.info("message ActAdministrator.iePoliceUpdated received from system");
		listOfMessages.add(new Message(MessageType.iePoliceUpdated));
		return new PtBoolean(true);
	}
