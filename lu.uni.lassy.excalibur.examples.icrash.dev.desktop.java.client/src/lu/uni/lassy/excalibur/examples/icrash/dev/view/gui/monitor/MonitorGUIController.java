...
public class MonitorGUIController extends AbstractGUIController implements HasTables {
	...
	*/
    ...
    /** The tableview of the polices in the system. */
    @FXML
    private TableView<CtPolice> tblvwPolices;
    ...
    public void populateTables(){
    	try {		
			...
			addPolisToTableView(tblvwPolices, systemStateController.getAllPolices());
    ...
    public void setUpTables(){
    	...
    	setUpPoliTables(tblvwPolices, true);
